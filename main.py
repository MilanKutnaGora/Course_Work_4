    ...
    while True:
        ...
        if platform_input not in ["0", "1", "2"]:
            ...
            if platform_input == "0":
                ...
                print(f"Вы выбрали платформу {platform[platform_input]}\n")
                ...
                if platform_input == "1":
                    ...
                    sj_vac_source = sj_block.get_vacancies()  # Получение вакансий с SuperJob
                    sj_valid_vac = sj_vac_info_validation(sj_vac_source)  # Валидация вакансий
