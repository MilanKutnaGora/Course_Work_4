    ...
    def functions_exe(self):
        ...
        if len(self.vac_list) > 0:
            ...
            while True:
                ...
                if chosen_func == "1":
                    all_vac_inst_1 = Vacancy(self.vac_list)
                ...
                if chosen_func == "2":
                    n_input = int(input(f"Введите желаемое количество вакансий для "
                                        f"обработки:\n> "))
                    all_vac_inst_2 = Vacancy(self.vac_list)
                ...
                if chosen_func == "3":
                    ...
                    all_vac_inst_3 = Vacancy(self.vac_list)
                ...
                if chosen_func == "4":
                    ...
                    all_vac_inst_4 = Vacancy(self.vac_list)
                ...
                if chosen_func == "6":
                    all_vac_inst_5 = Vacancy(self.vac_list)
